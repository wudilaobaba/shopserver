...
package com.whj.shop.shopserver.logic;

import com.whj.shop.shopserver.bo.SkuOrderBO;
import com.whj.shop.shopserver.dto.OrderDTO;
import com.whj.shop.shopserver.dto.SkuInfoDTO;
import com.whj.shop.shopserver.exception.http.ParameterException;
import com.whj.shop.shopserver.modelReal.OrderSku;
...
public class OrderChecker {
    ...
    private List<SkuEntity> serverSkuList;
    ...
    public OrderChecker(OrderDTO orderDTO, List<SkuEntity> serverSkuList,
    ...
    public void isOK() {
        ...
        for (int i = 0; i < this.serverSkuList.size(); i++) {
            SkuEntity sku = this.serverSkuList.get(i);
    ...
    private BigDecimal calculateSkuOrderPrice(SkuEntity sku, SkuInfoDTO skuInfoDTO){
    ...
    private void containsSoldOutSku(SkuEntity sku) {
        if (sku.getStock() == 0) {
            throw new ParameterException(50001);
        }
    }

    private void beyondSkuStock(SkuEntity sku, SkuInfoDTO skuInfoDTO) {
